...
public class Student {
    ...
    public Student(String name, int age) {
        if (age < 18 || age > 60) {
            throw new InvalidStudentException("Vârsta trebuie să fie între 18 și 60 de ani. (Primit: " + age + ")");
        }
        this.name = name;
        this.age = age;
    ...
    public void addGrade(Subject subject, double grade) {
        if (grade < 1 || grade > 10) {
            throw new InvalidGradeException("Nota trebuie să fie între 1 și 10. (Primit: " + grade + ")");
        }
    ...
    public String toString() {
        return String.format("Student{name='%s', age=%d, avg=%.2f, grades=%s}", name, age, getAverage(), grades);
    }
}